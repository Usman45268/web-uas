...
<html lang="en">
  <head>
    ...
    <!-- <link rel="icon" href="assets/image/pengumuman.png" class="rounded-circle"> -->
    <title>Home</title>
  </head>
  <body>
    <!--navbar-->
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-4"><b>
          PROMOSIKAN<br>PRODUK ANDA</b>
        </h1>
        <p class="lead">Buat produk anda lebih dikenal oleh umum dan dapatkan<br>lebih banyak pembeli</p>
      </div>
    </div>
